    ...
    <div class="left_open">
      ...
      <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="images/4.jpg" class="layui-nav-img">${sessionScope.ad.a_username}</a>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/golist">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>学生账户信息</cite>
                        </a>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show o_div" >
                <span class="o_span" style="height: 50px;padding: 20px;font-weight: bolder;font-family:华文行楷;font-size: 48px">管理员:${sessionScope.ad.a_name}，欢迎来到宿舍管理系统！</span>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">宿舍管理系统</div>
</div>
<!-- 底部结束 -->
