...
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.icss.domain.Dormitory" %>
...
<script>
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        <%--        error: function () {--%>
        <%--            //console.log(data);--%>
        <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findDormitory';},2000);--%>
        <%--        }--%>
        <%--    });--%>
        <%--});--%>
        ...
        $("#exp").click(function(){
            //跳转到controller
            location.href = "newexportdormlist";
        })
