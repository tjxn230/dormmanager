...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.icss.domain.StudentClean" %>
...
<div class="x-body">
    ...
    <xblock>
        ...
        <button id="exp" class="layui-btn layui-btn-warm" lay-filter="toolbarDemo" lay-submit=""><i class="layui-icon">&#xe67c;</i>导出</button>
    ...
    <script>
        ...
        layui.use(['jquery', 'excel','form','layer','laydate'], function(){
            ...
            <%--    $.ajax({--%>
            <%--        url: '${pageContext.request.contextPath}/exportstudentcleanlist',--%>
            <%--        type: 'post',--%>
            <%--        dataType: 'json',--%>
            ...
            <%--        error: function () {--%>
            <%--            //console.log(data);--%>
            <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findStudentClean';},2000);--%>
            <%--        }--%>
            <%--    });--%>
            <%--});--%>
            ...
            $("#exp").click(function(){
                //跳转到controller
                location.href = "newexportstuclenlist";
            })
            ...
            $("#addStudnetBtn").click(function () {
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        url: '${pageContext.request.contextPath}/addStudentClean',
                        type: "post",
        ...
        function member_del(obj,g_id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("${pageContext.request.contextPath}/deleteStudentClean",{"g_id":g_id},function (data) {
                    if(data =true){
