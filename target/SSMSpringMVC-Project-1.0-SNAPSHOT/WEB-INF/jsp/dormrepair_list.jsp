...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.icss.domain.DormRepair" %>
...
<div class="x-body">
    ...
    <script>
        ...
        layui.use(['jquery', 'excel','form','layer','laydate'], function(){
            ...
            <%--    $.ajax({--%>
            <%--        url: '${pageContext.request.contextPath}/exportdormrepairlist',--%>
            <%--        type: 'post',--%>
            <%--        dataType: 'json',--%>
            ...
            <%--        error: function () {--%>
            <%--            //console.log(data);--%>
            <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findDormRepair';},2000);--%>
            <%--        }--%>
            <%--    });--%>
            <%--});--%>
            ...
            $("#exp").click(function(){
                //跳转到controller
                location.href = "newexportdormrepairlist";
            })
            ...
            $("#addStudnetBtn").click(function () {
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        url: '${pageContext.request.contextPath}/addDormRepair',
                        type: "post",
        ...
        function member_del(obj,r_id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("${pageContext.request.contextPath}/deleteDormRepair",{"r_id":r_id},function (data) {
                    if(data =true){
