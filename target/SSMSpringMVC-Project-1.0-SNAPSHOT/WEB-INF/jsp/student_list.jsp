...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.icss.domain.Student" %>
...
<script>
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        $("#exp").click(function(){
            //跳转到controller
            location.href = "newexportstudentlist";
        })
        ...
        <%--        error: function () {--%>
        <%--            //console.log(data);--%>
        <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findStudent';},2000);--%>
        <%--        }--%>
        <%--    });--%>
        <%--});--%>
