...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.icss.domain.Class" %>
...
<div class="x-body">
    ...
    <script>
        ...
        layui.use(['jquery', 'excel','form','layer','laydate'], function(){
            ...
            <%--    $.ajax({--%>
            <%--        url: '${pageContext.request.contextPath}/exportclasslist',--%>
            <%--        type: 'post',--%>
            <%--        dataType: 'json',--%>
            ...
            <%--        error: function () {--%>
            <%--            //console.log(data);--%>
            <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findClass';},2000);--%>
            <%--        }--%>
            <%--    });--%>
            <%--});--%>
            ...
            $("#exp").click(function(){
                //跳转到controller
                location.href = "newexportclasslist";
            })
            ...
            $("#addStudnetBtn").click(function () {
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        url: '${pageContext.request.contextPath}/addClass',
                        type: "post",
        ...
        function member_del(obj,c_id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("${pageContext.request.contextPath}/deleteClass",{"c_id":c_id},function (data) {
                    if(data =true){
