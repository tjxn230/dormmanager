...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" import="com.icss.domain.Visitor" %>
...
<script>
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        <%--    $.ajax({--%>
        <%--        url: '${pageContext.request.contextPath}/exportvisitorlist',--%>
        <%--        type: 'post',--%>
        <%--        dataType: 'json',--%>
        ...
        <%--        error: function () {--%>
        <%--            //console.log(data);--%>
        <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findVisitor';},2000);--%>
        <%--        }--%>
        <%--    });--%>
        <%--});--%>
...
<%--新导出--%>
        $("#exp").click(function(){
            //跳转到controller
            location.href = "newexportvisitorlist";
        })
        ...
        $("#addStudnetBtn").click(function () {
            ...
            form.on('submit(formDemo)', function(data) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/addVisitor',
                    type: "post",
