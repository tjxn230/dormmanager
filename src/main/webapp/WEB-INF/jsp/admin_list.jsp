...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.icss.domain.Admin" %>
...
<script>
    ...
    layui.use(['jquery', 'excel', 'form','layer','laydate'], function(){
        ...
        <%--    $.ajax({--%>
        <%--        url: '${pageContext.request.contextPath}/exportadminlist',--%>
        <%--        type: 'post',--%>
        <%--        dataType: 'json',--%>
        ...
        <%--        error: function () {--%>
        <%--            //console.log(data);--%>
        <%--            setTimeout(function () {window.location.href='${pageContext.request.contextPath}/findAdmin';},2000);--%>
        <%--        }--%>
        <%--    });--%>
        <%--});--%>
        ...
        $("#exp").click(function(){
            //跳转到controller
            location.href = "newexportadminlist";
        })
