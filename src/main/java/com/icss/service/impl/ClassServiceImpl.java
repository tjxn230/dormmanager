...
public class ClassServiceImpl implements ClassService {
    ...
    //查询宿舍人员信息
    @Override
    public List<Class> findClassStudent(String c_classname, Integer c_classid) {
        List<Class> c = classDao.findClassStudent(c_classname, c_classid);
        return c;
    }
}
